...
// TODO: Flipping the screen somehow resets all values?
...
public class MainActivity extends AppCompatActivity {
    ...
    private String curName = "undefined";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outputName = (EditText) findViewById(R.id.output_name);
        outputStand = (EditText) findViewById(R.id.output_stand);
    ...
    private String getWebPage(String targetAddr) throws IOException {
        ...
        try {
            ...
            StringBuffer stringBuffer = new StringBuffer();  // TODO: Replace with sctringbuilder, unless it breaks something
            String line;
